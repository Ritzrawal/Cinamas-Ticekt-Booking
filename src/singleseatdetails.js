...
include =(arr, obj) => {
  ...
  console.log(this.state.price)
    ...
    render() {
      console.log("seat on seat wise",JSON.parse(this.props.globaldata.seat)["Platinum"],this.props.globaldata.price)
            ...
            <Row className="clearfix">
              <Col className="mid-lev" sm={12}>
                <Nav bsStyle="pills" stacked>
                  <NavItem 
                  className={(this.props.seatCatagorycancle == "sell"  || this.props.seatCatagorycancle == "complimentary" || !this.include(this.props.roles.split(","), "sell") ) ? "displayNone" : " mid-lev-btn" }
                  ...
                  <div className="form-group">
                        ...
                        >        
                          ...
                          <label >Payment Type  :{this.props.globaldata.payment_type}</label>
                             ...
                             <div 
                          className={(this.props.globaldata.payment_type == "card") ? "displayNone": "form-group" }
                        >
                    ...
                    />
                        ...
                        <div 
                       className={(this.props.globaldata.payment_type == "card") ? "form-group": "displayNone" }
                        >
